...
if (get_config('theme_spacechild', 'secnavitems')) {
    ...
    for ($secnavindex = 1; $secnavindex <= $navitems; $secnavindex++) {
        ...
        $name = 'theme_spacechild/secnavuserroles' . $secnavindex;
        $title = get_string('secnavuserroles', 'theme_spacechild');
        $description = get_string('secnavuserroles_desc', 'theme_spacechild');
        $options = [];
        $options[0] = get_string('all', 'moodle');
        $options[1] = get_string('rolemanager', 'theme_spacechild');
        $options[2] = get_string('rolecoursecreator', 'theme_spacechild');
        $options[3] = get_string('roleeditingteacher', 'theme_spacechild');
        $options[4] = get_string('rolenoneditingteacher', 'theme_spacechild');
        $options[5] = get_string('rolestudent', 'theme_spacechild');
        $options[6] = get_string('roleguest', 'theme_spacechild');
        $options[7] = get_string('roleauthenticateduser', 'theme_spacechild');
