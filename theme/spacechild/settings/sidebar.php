...
$name = 'theme_spacechild/displayfilterhiddenchbx';
$title = get_string('displayfilterhiddenchbx', 'theme_spacechild');
$description = get_string('displayfilterhiddenchbx_desc', 'theme_spacechild');
$default = 1;
$setting = new admin_setting_configcheckbox($name, $title, $description, $default);
$page->add($setting);
