...
$setting = new admin_setting_configtextarea('theme_spacechild/additionalheadscripts',
    get_string('additionalheadscripts', 'theme_spacechild'), get_string('empty_desc', 'theme_spacechild'), '');
$page->add($setting);
