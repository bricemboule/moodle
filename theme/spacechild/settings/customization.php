...
$description = get_string('btnborderradius_desc', 'theme_spacechild');
...
$name = 'theme_spacechild/hdmgeneral';
$heading = get_string('hdmgeneral', 'theme_spacechild');
$setting = new admin_setting_heading($name, $heading, format_text(get_string('hgeneral_desc', 'theme_spacechild'), FORMAT_MARKDOWN));
$page->add($setting);

$name = 'theme_spacechild/dmcolorbodybg';
$title = get_string('dmcolorbodybg', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorborder';
$title = get_string('dmcolorborder', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/hdmcolorstxt';
$heading = get_string('hdmcolorstxt', 'theme_spacechild');
$setting = new admin_setting_heading($name, $heading, format_text(get_string('hdmcolorstxt_desc', 'theme_spacechild'), FORMAT_MARKDOWN));
$page->add($setting);

$name = 'theme_spacechild/dmcolorbody';
$title = get_string('dmcolorbody', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorbodysecondary';
$title = get_string('dmcolorbodysecondary', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorbodylight';
$title = get_string('dmcolorbodylight', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorheadings';
$title = get_string('dmcolorheadings', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorlink';
$title = get_string('dmcolorlink', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorlinkhover';
$title = get_string('dmcolorlinkhover', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/hdmcolorsgrays';
$heading = get_string('hdmcolorsgrays', 'theme_spacechild');
$setting = new admin_setting_heading($name, $heading,
    format_text(get_string('hdmcolorsgrays_desc', 'theme_spacechild'), FORMAT_MARKDOWN));
$page->add($setting);

$name = 'theme_spacechild/dmcolorgray100';
$title = get_string('dmcolorgray100', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorgray200';
$title = get_string('dmcolorgray200', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorgray300';
$title = get_string('dmcolorgray300', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorgray400';
$title = get_string('dmcolorgray400', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorgray500';
$title = get_string('dmcolorgray500', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorgray600';
$title = get_string('dmcolorgray600', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorgray700';
$title = get_string('dmcolorgray700', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorgray800';
$title = get_string('dmcolorgray800', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/dmcolorgray900';
$title = get_string('dmcolorgray900', 'theme_spacechild');
$description = get_string('dmcolor_desc', 'theme_spacechild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);
