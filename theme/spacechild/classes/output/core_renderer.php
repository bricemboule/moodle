...
class core_renderer extends \core_renderer {
     ...
     */
    public function theme_spacechild_themedir() {
        global $CFG;
    ...
    public function theme_part($name, $vars = []) {
        ...
        if (file_exists($candidate1)) {
            ...
            $candidate = $CFG->dirroot . theme_spacechild_themedir() . '/space/layout/parts/' . $element;
        }
    ...
    public function mainsidebarmenu() {
        ...
        if (isloggedin() && !isguestuser()) {
            ...
            if (get_config('theme_spacechild', 'isitemonmycourses') == 1) {
                ...
                $posmycourses = (!empty(get_config('theme_spacechild', 'posmycourses'))) ? $theme->settings->posmycourses : '6';
            }
            ...
            if ($theme->settings->iscustomitem1on == true) {
                ...
                $customitemrole1 = theme_spacechild_get_setting("customitemrole1");
            ...
            if ($theme->settings->iscustomitem2on == true) {
                ...
                // User role restriction.
                $customitemrole2 = theme_spacechild_get_setting("customitemrole2");
            ...
            if ($theme->settings->iscustomitem3on == true) {
                ...
                // User role restriction.
                $customitemrole3 = theme_spacechild_get_setting("customitemrole3");
            ...
            if ($theme->settings->iscustomitem4on == true) {
                ...
                // User role restriction.
                $customitemrole4 = theme_spacechild_get_setting("customitemrole4");
            ...
            if ($theme->settings->iscustomitem5on == true) {
                ...
                // User role restriction.
                $customitemrole5 = theme_spacechild_get_setting("customitemrole5");
    ...
    public function space_mycourses() {
        ...
        $displayfilterhiddenchbx = theme_spacechild_get_setting('displayfilterhiddenchbx');
    ...
    public function moremenu_custom_items() {
        ...
        if ($this->page->theme->settings->secnavitems == 1) {
            ...
            for ($i = 1; $i <= $secnavcount; $i++) {
                ...
                // User role restriction.
                $selectrole = theme_spacechild_get_setting("secnavuserroles$i");
