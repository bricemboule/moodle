...
$string['configtitle'] = 'Space Child';
...
$string['pluginname'] = 'Space Child (2.5.27)';
$string['privacy:metadata'] = 'The space child theme does not store any personal data about any user.';
